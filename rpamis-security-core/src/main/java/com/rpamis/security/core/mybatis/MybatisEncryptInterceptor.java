...
/**
 * Mybatis加密拦截器，入库时加密，查询时加密做等值查询 同时兼容mybatis plus 区别于
 *
...
public class MybatisEncryptInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		try {
			...
			LOGGER.error(
					"encrypt process: rpamis security mybatis encrypt interceptor unknown exception, the original value is returned, and no impact is caused",
					e);
			return invocation.proceed();
		}
	}
