...
public class ProcessContext {
	...
	public ProcessContext(Object currentObject, Object fieldValue, Field field, Class<?> fieldValueClass,
			Set<Integer> referenceSet, List<TypeHandler> handlerList, Deque<Object> analyzeDeque) {
