...
<Callout type="success" title="💡 版本兼容性提示">
  对于 **JDK 17+** 使用版本 <code>1.1.4</code>，**JDK 8-JDK 17** 使用版本 <code>1.0.7</code>。
</Callout>
...
```groovy
// JDK 17+
implementation 'com.rpamis:rpamis-security-spring-boot-starter:1.1.4'

// JDK 8-JDK 17
implementation 'com.rpamis:rpamis-security-spring-boot-starter:1.0.7'
```
